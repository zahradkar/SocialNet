...
async function sendPost() {
    ...
    if (response.ok) {
        ...
        if (document.querySelector('.preview img'))
            receivedData.content = document.querySelector('.preview img').getAttribute('src');
        const newPost = document.createElement('div');
        newPost.classList.add("post");
        newPost.id = receivedData.postId;
        ...
        newPost.innerHTML += `
          <div class="post__foot">
            <div class="likes-container color--primary">
              <button class="btn-upvote btn--round color--primary check-login" onclick="vote(this, 'up')">
              ...
              <button class="btn-downvote btn--round color--primary check-login" onclick="vote(this, 'down')">
